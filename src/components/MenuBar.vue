<template>
  <div class="menu-bar">
    <transition name="slide-up">
      <div class="menu-wrapper" :class="{'hide-box-shadow': 'ifSettinShow || !nee'}" v-show="nee">
    ...
    <transition name="slide-up">
      <div class="setting-wrapper" v-show="ifSettinShow">
        <div class="setting-font-size" v-if="showTap === 0">
        ...
        <div class="setting-theme" v-else-if="showTap === 1">
          <div class="setting-theme-item" v-for="(item, index) in themeList" :key="index" @click="setTheme(index)">
            ...
            <div class="theme-text" :class="{'selected': index === defaultTheme}">{{item.name}}</div>
          </div>
        </div>
        <div class="setting-progress" v-else-if="showTap === 2">
...
export default {
  ...
  methods: {
    ...
    showSetting(tag) {
      this.showTap = tag;
      if (this.showTap === 3) {
        this.ifSettinShow = false;
        this.ifShowContent = true;
      } else {
        this.ifSettinShow = true;
      }
    },
    hideSetting() {
      this.ifSettinShow = false;
        ...
        .select-wrapper {
          ...
          .point-wrapper {
            ...
            .point {
              ...
              box-shadow: 0 pxrem(4) px2rem(4) rgba(0, 0, 0, 0.15);
              @include center;
              .small-point {
                width: px2rem(5);
                height: px2rem(5);
